            ...
            <div class="nav-drop-menu nav-drop-menu--wide">
                <div class="mega-inner">
                    ...
                    <div class="mega-grid">
                        ...
                        <a href="/certificado-digital-cdl/" class="mega-item"><div class="mi-ico mi-ico-gold"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="11" width="18" height="11" rx="2"/><path d="M7 11V7a5 5 0 0110 0v4"/></svg></div><div><h5>Certificado Digital</h5><p>A1 PJ anual sem custo</p></div></a>
                        <a href="/cdl-mais-voce/" class="mega-item"><div class="mi-ico mi-ico-blue"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20.84 4.61a5.5 5.5 0 00-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 00-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 000-7.78z"/></svg></div><div><h5>CDL Mais Você</h5><p>App de avaliações e cupons</p></div></a>
                    </div>
                </div>
