        ...
        <div class="nav-dropdown">
            ...
            <div class="nav-drop-menu">
                <div class="mega-inner">
                    ...
                    <div class="mega-grid">
                        <a href="/sobre-nos/" class="mega-item"><div class="mi-ico mi-ico--img"><img src="<?php echo CDL_THEME_URI; ?>/assets/img/menu-icons/sobre-nos.webp" alt="" width="40" height="40" loading="lazy" decoding="async"></div><div><h5>Sobre Nós</h5><p>Nossa história e missão</p></div></a>
                        <a href="/diretoria/" class="mega-item"><div class="mi-ico mi-ico--img"><img src="<?php echo CDL_THEME_URI; ?>/assets/img/menu-icons/diretoria.webp" alt="" width="40" height="40" loading="lazy" decoding="async"></div><div><h5>Diretoria</h5><p>Gestão e liderança</p></div></a>
                        <a href="/presidentes/" class="mega-item"><div class="mi-ico mi-ico--img"><img src="<?php echo CDL_THEME_URI; ?>/assets/img/menu-icons/presidentes.webp" alt="" width="40" height="40" loading="lazy" decoding="async"></div><div><h5>Presidentes</h5><p>Galeria de presidentes</p></div></a>
                        <a href="/cdl-jovem/" class="mega-item"><div class="mi-ico mi-ico--img"><img src="<?php echo CDL_THEME_URI; ?>/assets/img/menu-icons/cdl-jovem.webp" alt="" width="40" height="40" loading="lazy" decoding="async"></div><div><h5>CDL Jovem</h5><p>Programa jovens líderes</p></div></a>
                        <a href="/cdl-mulher/" class="mega-item"><div class="mi-ico mi-ico--img"><img src="<?php echo CDL_THEME_URI; ?>/assets/img/menu-icons/cdl-mulher.webp" alt="" width="40" height="40" loading="lazy" decoding="async"></div><div><h5>CDL Mulher</h5><p>Empreendedorismo feminino</p></div></a>
                        <a href="/merito-empresarial/" class="mega-item"><div class="mi-ico mi-ico--img"><img src="<?php echo CDL_THEME_URI; ?>/assets/img/menu-icons/merito-empresarial.webp" alt="" width="40" height="40" loading="lazy" decoding="async"></div><div><h5>Mérito Empresarial</h5><p>Premiação anual</p></div></a>
                        <a href="/lgpd/" class="mega-item"><div class="mi-ico mi-ico--img"><img src="<?php echo CDL_THEME_URI; ?>/assets/img/menu-icons/lgpd.webp" alt="" width="40" height="40" loading="lazy" decoding="async"></div><div><h5>LGPD</h5><p>Política de privacidade</p></div></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="nav-drop-menu nav-drop-menu--wide">
                <div class="mega-inner">
                    ...
                    <div class="mega-grid">
                        ...
                        <a href="/espacos-corporativos/" class="mega-item"><div class="mi-ico mi-ico--img"><img src="<?php echo CDL_THEME_URI; ?>/assets/img/menu-icons/espacos-corporativos.webp" alt="" width="40" height="40" loading="lazy" decoding="async"></div><div><h5>Espaços Corporativos</h5><p>Salas equipadas para reuniões</p></div></a>
        ...
        <div class="nav-dropdown">
            ...
            <div class="nav-drop-menu">
                <div class="mega-inner">
                    ...
                    <div class="mega-grid">
                        <a href="/cdl-celular/" class="mega-item"><div class="mi-ico mi-ico--img"><img src="<?php echo CDL_THEME_URI; ?>/assets/img/menu-icons/cdl-celular.webp" alt="" width="40" height="40" loading="lazy" decoding="async"></div><div><h5>CDL Celular</h5><p>Consultas e proteção mobile</p></div></a>
                        <a href="/central-de-cobrancas/" class="mega-item"><div class="mi-ico mi-ico--img"><img src="<?php echo CDL_THEME_URI; ?>/assets/img/menu-icons/central-cobrancas.webp" alt="" width="40" height="40" loading="lazy" decoding="async"></div><div><h5>Central de Cobranças</h5><p>Recuperação de crédito</p></div></a>
                        <a href="/certificado-digital-cdl/" class="mega-item"><div class="mi-ico mi-ico--img"><img src="<?php echo CDL_THEME_URI; ?>/assets/img/menu-icons/certificado-digital.webp" alt="" width="40" height="40" loading="lazy" decoding="async"></div><div><h5>Certificado Digital</h5><p>A1 e A3 para PF e PJ</p></div></a>
