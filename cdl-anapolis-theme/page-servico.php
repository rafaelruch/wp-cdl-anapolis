...
<section class="page-hero" style="background-image:url('<?php echo esc_url($hero_img_url); ?>')">
    ...
    <div class="wrap page-hero__content">
        ...
        <div class="ao ao-d3" style="margin-top:24px">
            <a href="#" data-cdl-compra-certificado class="btn btn-gold">
...
$msg_ind = 'Olá! Tenho interesse no plano *Individual* do Tempo & Saúde (R$ 20/mês, assinatura anual). Pode me passar as condições e como ativar?';
$msg_fam = 'Olá! Tenho interesse no plano *Família* do Tempo & Saúde (R$ 24,90/mês, assinatura anual, titular + até 3 dependentes). Pode me passar as condições e como ativar?';
$wa_url_ind = 'https://wa.me/' . esc_attr($whatsapp_number) . '?text=' . rawurlencode($msg_ind);
$wa_url_fam = 'https://wa.me/' . esc_attr($whatsapp_number) . '?text=' . rawurlencode($msg_fam);
?>
    ...
    <div class="wrap" style="text-align:center">
        ...
        <div class="pricing-grid" style="max-width:760px;margin-left:auto;margin-right:auto;grid-template-columns:repeat(2,1fr)">
            ...
            <div class="pricing-card ao">
                ...
                <a href="<?php echo $wa_url_ind; ?>" target="_blank" rel="noopener" class="btn btn-whatsapp pricing-card__cta">
                    <?php echo $wa_svg; ?>
                    Ativar plano pelo WhatsApp
                </a>
            </div>
            ...
            <div class="pricing-card pricing-card--featured ao ao-d1">
                ...
                <a href="<?php echo $wa_url_fam; ?>" target="_blank" rel="noopener" class="btn btn-whatsapp pricing-card__cta">
                    <?php echo $wa_svg; ?>
                    Ativar plano pelo WhatsApp
                </a>
            </div>
...
<section class="cta-gold">
    ...
    <?php if ($slug === 'certificado-digital'): ?>
        <a href="#" data-cdl-compra-certificado class="btn btn-dark ao ao-d2">
